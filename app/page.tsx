  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 py-6 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* YMYL Disclaimer - E-E-A-T Compliance */}
        <div className="bg-amber-50 dark:bg-amber-900/10 border-l-4 border-amber-500 dark:border-amber-600 rounded-lg p-5 mb-6 shadow-sm">
          <div className="flex items-start gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-amber-600 dark:text-amber-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <div className="flex-1">
              <h3 className="font-bold text-amber-900 dark:text-amber-100 text-sm mb-1.5">
                Important: Estimates Only
              </h3>
              <p className="text-sm text-amber-800 dark:text-amber-200 leading-relaxed">
                This calculator provides <strong>estimates only</strong> and does not constitute financial advice.
                Actual loan terms, interest rates, and fees may vary based on your credit history, business financials,
                and lender requirements. Always consult with an <strong>SBA-approved lender</strong> for accurate,
                personalized loan information. See our <a href="/disclaimer" className="underline font-semibold hover:text-amber-900 dark:hover:text-amber-100">full disclaimer</a>.
              </p>
            </div>
          </div>
        </div>
